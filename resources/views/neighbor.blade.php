...
<meta name="description" content="{{$info['town']}}, {{$info['location']}}  local notices and open conversation posted by Neighborhood Reporter readers">
<!-- Open Graph / Facebook -->
...
<meta property="og:description" content="{{$info['town']}}, {{$info['location']}}  local notices and open conversation posted by Neighborhood Reporter readers">
...
<meta property="twitter:description" content="{{$info['town']}}, {{$info['location']}}  local notices and open conversation posted by Neighborhood Reporter readers">
