    ...
    <div class="footer container">
        ...
        <div class="footer__section--full">
            <ul class="footer__social-list">
                <li><a class="list-item__link footer__item--spacing list-item__link--xs" title="Contact Neighborhood Reporter at support@neighborhoodreporter.com" href="mailto:info@neighborhoodreporter.com">
                ...
                <li>
                    <a class="list-item__link footer__item--spacing list-item__link--xs" target="_blank" title=" Neighborhood Reporter On Facebook" href="https://www.facebook.com/The-Neighborhood-Reporter-100827435709729" rel="nofollow noopener">
                        <span class="fa-stack fa-lg">
                            <span class="fal far fa-circle fa-stack-2x"></span>
        ...
        <div class="footer__copyright">
            Neighborhood Reporter Media | 134 W 29th Street, New York, NY 10001<br/>
            {{-- &COPY; <!-- -->2021<!-- --> <a class="list-item__link" title="Neighborhood Reporter" href="/">Neighborhood Reporter</a> <!-- -->Media. All Rights Reserved. --}}
            Copyright &COPY; 2021 <a class="list-item__link" title="Neighborhood Reporter" href="{{route('home')}}"> Neighborhood Reporter</a> Media. All rights reserved
        </div>        
    </div>
</footer>
...
<!--[if lte IE 8]><script type="text/javascript" src="js/excanvas.min.js"></script><![endif]-->
    ...
    <script type="text/javascript">
        tinymce.init({
            selector: '#mytextarea',
            plugins: 'preview code emoticons image table paste lists advlist link hr charmap directionality',
        toolbar: 'formatselect fontselect fontsizeselect bold italic underline strikethrough forecolor backcolor subscript superscript | alignleft aligncenter alignright alignjustify indent outdent rtl ltr | bullist numlist | emoticons image table link hr charmap',
