@extends('layouts.app')
@section('title')
{{$info['location']}} Neighborhood Reporter - Breaking Local News
@endsection
@section('meta')
<!-- Primary Meta Tags -->
<meta name="title" content="Across {{$info['location']}} Neighborhood Reporter - Breaking News, Local News, Events, Schools, Weather, Sports and Shopping">
<meta name="description" content="Local news and events from Across {{$info['location']}} Neighborhood Reporter. Latest headlines: Gabby Petito Funeral, Day 8 Of Brian Laundrie Search Draws Blank; Rays Playoffs Could Be Muddied By Split Season With Montreal; How To Host A Neighborhood Plant Swap ​—​ No Green Thumb Required">
<!-- Open Graph / Facebook -->
<meta property="og:locale" content="{{str_replace('_', '-', app()->getLocale())}}">
<meta property="og:type" content="article">
<meta property="og:url" content="{{route('home')}}/r/{{sanitizeStringForUrl($info['location'])}}">
<meta property="og:title" content="Across {{$info['location']}} Neighborhood Reporter - Breaking News, Local News, Events, Schools, Weather, Sports and Shopping">
<meta property="og:description" content="Local news and events from Across {{$info['location']}} Neighborhood Reporter. Latest headlines: Gabby Petito Funeral, Day 8 Of Brian Laundrie Search Draws Blank; Rays Playoffs Could Be Muddied By Split Season With Montreal; How To Host A Neighborhood Plant Swap ​—​ No Green Thumb Required">
...
<meta property="twitter:url" content="{{route('home')}}/r/{{sanitizeStringForUrl($info['location'])}}">
<meta property="twitter:title" content="Across {{$info['location']}} Neighborhood Reporter - Breaking News, Local News, Events, Schools, Weather, Sports and Shopping">
<meta property="twitter:description" content="Local news and events from Across {{$info['location']}} Neighborhood Reporter. Latest headlines: Gabby Petito Funeral, Day 8 Of Brian Laundrie Search Draws Blank; Rays Playoffs Could Be Muddied By Split Season With Montreal; How To Host A Neighborhood Plant Swap ​—​ No Green Thumb Required">
...
<div class="content-sec">
    <div class="container">
        <div class="styles_Communities">
            <h3 class="styles_Communities_title">Communities in {{$info['location']}}</h3>
            <div>
                @php $Community = getRegionCommunity($info['location']); @endphp
                <ul class="styles_Communities_list term-list">
                    @if(count($Community) > 0)
                    @foreach($Community as $value)
                    <li class="styles_Communities_listItem term-item">
                        <a class="styles_Communities_link" href="/l/{{sanitizeStringForUrl($value['rname'])}}/{{sanitizeStringForUrl($value['name'])}}">
                            <i class="fa fa-map-marker-alt icon icon--space-right text text--primary"></i>{{$value['name']}}
                        </a>
                    </li>
                    @endforeach
                    @endif
...
<script>
    function loadMoreData(id = 0, url) {
        $.ajax({
            type: 'POST',
            url: url,
            data: {id: id, location: $('#location').val()},
            headers: {
...
//            return false;
        ...
        $('ul.term-list').each(function () {
            ...
            if (LiN > 19) {
                $('li', this).eq(19).nextAll().hide().addClass('toggleable');
                $(this).append('<li class="styles_CommunitiesBlock_btn moreless-button">Show more</li>');
            }
        });


        $('ul.term-list').on('click', '.styles_CommunitiesBlock_btn.moreless-button', function () {
