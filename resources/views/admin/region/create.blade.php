    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" action="{{ route('regions.store') }}" method="POST" novalidate>
                            @csrf
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Region Code <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <input id="name" class="form-control col-md-6 col-xs-6" required="required" type="text" name="region_code" maxlength="2" value="{{ old('region_code') }}">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Advertisement Script</label>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <textarea class="form-control col-md-6 col-xs-6" rows="3" name="advertisement">{{ old('advertisement') }}</textarea>
                                </div>
                            </div>
