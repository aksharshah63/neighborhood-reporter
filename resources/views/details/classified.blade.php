@extends('layouts.app')
@section('title')
{{$info['title']}} - {{$info['town']}}, {{$info['location']}} Neighborhood Reporter
@endsection
@section('meta')
@php
if ($info['image'] != '') {
...
$des = implode(' ', array_slice(str_word_count(strip_tags($info['description']), 2), 0, 20)).'...';
$info['title'] = str_replace('"', "'", $info['title']);
@endphp
<!-- Primary Meta Tags -->
<meta name="title" content="Local {{$info['category']}} : {{$info['title']}} | Neighborhood Reporter">
...
<meta property="og:url" content="{{route('home')}}/c/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}">
<meta property="og:title" content="Local {{$info['category']}}:{{$info['title']}} | Neighborhood Reporter">
...
<meta property="twitter:url" content="{{route('home')}}/c/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}">
<meta property="twitter:title" content="Local {{$info['category']}}:{{$info['title']}} | Neighborhood Reporter">
            ...
            <div class="col-md-12 col-lg-8 pad-0">
                <main id="main" role="main" class="page__main event-page">
                    <section class="st_Section event-sec">
                        <div class="st_SocialShare st_SocialShare--IsHidden st_SocialShare--IsSticky">
                            <a class="st_SocialShare__Action st_SocialShare__Action--facebook" target="_blank"
                               ...
                               href="https://www.facebook.com/sharer/sharer.php?u={{route('home')}}/c/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=facebook&utm_medium=web&utm_campaign=share">
                            ...
                            <a class="st_SocialShare__Action st_SocialShare__Action--twitter" target="_blank" alt="Tweet"
                               title="Tweet"
                               href="https://twitter.com/intent/tweet?text={{$info['title']}}&amp;url={{route('home')}}/c/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=twitter&utm_medium=web&utm_campaign=share">
                            ...
                            <a class="st_SocialShare__Action st_SocialShare__Action--linkedin" target="_blank"
                               ...
                               href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{route('home')}}/c/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=linkedin&utm_medium=web&utm_campaign=share">
                            ...
                            <a class="st_SocialShare__Action st_SocialShare__Action--reddit" target="_blank"
                               ...
                               href="http://www.reddit.com/submit?title={{$info['title']}}&amp;url={{route('home')}}/c/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=reddit&utm_medium=web&utm_campaign=share">
                            ...
                            <a class="st_SocialShare__Action st_SocialShare__Action--email" target="_blank" alt="Send email"
                               title="Send email"
                               href="mailto:?subject={{$info['title']}}&amp;body={{$info['venue']}}%0A%0A{{route('home')}}/c/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=shared-email&utm_medium=email&utm_campaign=share">
                        ...
                        <article class="st_Section__card">
                            <div class="st_CardDetail__Header">
                                <h6 class="st_Card__LabelWrapper">
                                    ...
                                    <span class="st_Card__LabelDivider">|</span>
                                    {!!getClassifiedIcon($info['category'])!!}
                                    <span>{{$info['category']}}</span>
                                    <span class="st_Card__LabelDivider">|</span>

                                    <a class="byline__secondary" href="/c/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}">
                            ...
                            <div class="st_HTMLContent">
                                ...
                                <br>
                                <div class="st_CardDetail_Footer">
                                    <div class="accordion" id="faq">
                                        <div class="card">
                                            <div class="card-header" id="faqhead1"> <button class="ConPosterForm-ConPosterForm-ButtonToggle collapsed" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1"><strong>Contact this poster directly</strong></button> </div>
                                            <div id="faq1" class="collapse" aria-labelledby="faqhead1" data-parent="#faq">
                                                <div class="card-body">
                                                    <form class="ConPosterForm-ConPosterForm-Form" id="sendClassifiedContact" style="">
                                                        @csrf
                                                        <input type="hidden" name="classifiedId" value="{{$info['id']}}" />
                                                        <label class="ConPosterForm-ConPosterForm-Field">
                                                            <i class="fa fa-envelope ConPosterForm-ConPosterForm-Icon"></i>
                                                            <input type="email" class="ConPosterForm-ConPosterForm-Input conatct_email" name="email" placeholder="Enter your email" required="" value="">
                                                        </label>
                                                        <label class="ConPosterForm-ConPosterForm-Field text-area">
                                                            <textarea class="ConPosterForm-ConPosterForm-Input contact_message" name="message" placeholder="Write your message" required="" rows="8"></textarea>
                                                        </label>
                                                        <div class="ConPosterForm-ConPosterForm-Field ConPosterForm-ConPosterForm-Field-FlushRight">
                                                            <button class="ConPosterForm-ConPosterForm-SubmitButton" id="sendContactBtn" type="button">Send message<i class="fas fa-spinner icon icon--space-left fa-spin" style="display: none;"></i></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                            ...
                            <div class="st_CardDetail__Footer">
                                <div class="st_ActionBar">
                                    <div class="st_ActionBar__BarLeft">
                                        <button aria-label="thank" class="Button_ActionBar like_button-post" data-postid="{{$info['id']}}" data-type="classified" type="button">
                                        ...
                                        <button class="Button_ActionBar share share-button" data-title="{{$info['title']}}" data-url="/c/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}" type="button"> 
                                            <span class="Button_ActionBar__Icon">
                                        ...
                                        <div class="st_FlagMenu">
                                            <div aria-label="flags" class="dropdown">
                                                <div class="js-content-flag-menu" aria-haspopup="true" aria-expanded="false" disabled="">
                                                    ...
                                                    <div class="flag-menu">
                                                        <ul class="dropdown-menu dropdown-menu-right" data-postid="{{$info['id']}}" data-type="classified">
                                        ...
                                        <div class="st_Thread st_Thread--collapsed styles_Thread__3lAiJ" id="reply_div_{{$rvalue['id']}}">
                                            <section>
                                                ...
                                                <div class="st_ActionBar action_remove_{{$rvalue['id']}}">
                                                    <div class="st_ActionBar__BarLeft">
                                                        <button aria-label="thank" class="Button_ActionBar like_button-post" data-postid="{{$rvalue['id']}}" data-type="classified_reply" type="button">
                                                            <span class="Button_ActionBar__Icon">
                                                                <?php
                                                        ...
                                                        <div class="st_FlagMenu">
                                                            <div aria-label="flags" class="dropdown">
                                                                ...
                                                                <div class="dropdown-toggle" aria-haspopup="true" aria-expanded="false" disabled="">
                                                                    ...
                                                                    <div class="flag-menu">
                                                                        <ul class="dropdown-menu dropdown-menu-right" data-option='report' data-postid="{{$rvalue['id']}}" data-type="classified_reply">
                                                                            <li class="st_FlagMenu__label">Reason for reporting:</li>
                                                                            <li class="st_FlagItem__link dropdown-item"><span>Spam</span></li>
                                                                            <li class="st_FlagItem__link dropdown-item"><span>Promotional</span></li>
                                                                            <li class="st_FlagItem__link dropdown-item"><span>Disagree</span></li>
                                            ...
                                            <div class="st_Thread st_Thread--collapsed styles_Thread__3lAiJ" id="reply_div_{{$crvalue['id']}}">
                                                <section>
                                                    ...
                                                    <div class="st_ActionBar action_remove_{{$crvalue['id']}}">
                                                        <div class="st_ActionBar__BarLeft">
                                                            <button aria-label="thank" class="Button_ActionBar like_button-post" data-postid="{{$crvalue['id']}}" data-type="classified_reply" type="button">
                                                                <span class="Button_ActionBar__Icon">
                                                                    <?php
                                                            ...
                                                            <div class="st_FlagMenu">
                                                                <div aria-label="flags" class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-toggle" aria-haspopup="true" aria-expanded="false" disabled="">
                                                                        ...
                                                                        <div class="flag-menu">
                                                                            <ul class="dropdown-menu dropdown-menu-right" data-option='report' data-postid="{{$crvalue['id']}}" data-type="classified_reply">
                                                                                <li class="st_FlagMenu__label">Reason for reporting:</li>
                                                                                <li class="st_FlagItem__link dropdown-item"><span>Spam</span></li>
                                                                                <li class="st_FlagItem__link dropdown-item"><span>Promotional</span></li>
                                                                                <li class="st_FlagItem__link dropdown-item"><span>Disagree</span></li>
                    ...
                    <section class="st_Section__1bIk_ Classifieds-sec" data-nosnippet="true">
                        @if(count($info['classifiedList']) > 1)
                    ...
                    <section class="regular slider">
                        ...
                        <div>
                            <article class="st_CardCompact">
                                ...
                                @if($epost['image'] != '')
                                <a class="st_CardCompact__ImageLink" href="/e/{{$epost['id']}}/{{sanitizeStringForUrl($epost['title'])}}">
...
//            return false;
        ...
        $(document).on("click", "#sendContactBtn", function () {
            if ($(".conatct_email").val() == '') {
                $(".conatct_email").parents('label').css('border-bottom', '2px solid #d20000');
            } else if ($(".contact_message").val() == '') {
                $(".contact_message").parents('label').css('border-bottom', '2px solid #d20000');
                $(".conatct_email").parents('label').css('border-bottom', '2px solid #e9e9e9');
            } else if ($(".conatct_email").val() != '' && $(".contact_message").val() != '') {
                $(".contact_message").parents('label').css('border-bottom', '0');
                $(".conatct_email").parents('label').css('border-bottom', '2px solid #e9e9e9');
                $(this).find('i').show();
                var $this = $(this);
                var formData = new FormData($("#sendClassifiedContact")[0]);
                $.ajax({
                    type: 'POST',
                    url: "{{ route('sent-classified-contact') }}",
                    data: formData,
                    dataType: 'json',
                    cache: false,
                    contentType: false,
                    ...
                    success: function (data) {
                        ...
                        toastr.success("Classified Contact sent successfully.!");
                        $this.find('i').hide();
                        document.getElementById("sendClassifiedContact").reset();
                        $(".ConPosterForm-ConPosterForm-ButtonToggle").trigger('click');
                    }
                });
            }
        });
        ...
        $(document).on("click", "#comment_replay-btn", function () {
            if ($("#replay_message-box").val() == '') {
                ...
                if ($('#login_user_id').val() == '') {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('add-classified-comment') }}",
                        data: formData,
                        dataType: 'json',
                        cache: false,
                        contentType: false,
            ...
            if ($(this).parent().data('option') == 'edit') {
                if ($(this).find('span').text() == 'Edit') {
                    ...
                    if (confirm('Are you sure you want to delete this reply?')) {
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('delete-classified-comment') }}",
        ...
        $(document).on("click", "#edit_replay-btn", function () {
            if ($("#edit_message-box").val() == '') {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('edit-classified-comment') }}",
                    data: formData,
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
