@extends('layouts.app')
@section('title')
{{ \Carbon\Carbon::parse($info['date'])->format('M d') }} | {{$info['title']}} | {{$info['town']}}, {{$info['location']}} Neighborhood Reporter
@endsection
@section('meta')
@php
if ($info['image'] != '') {
...
$des = \Carbon\Carbon::parse($info['created_at'])->format('D, M j Y') . ' - Venue:-' . $info['venue'];
$info['title'] = str_replace('"', "'", $info['title']);
@endphp
<!-- Primary Meta Tags -->
<meta name="title" content="Local Event:{{$info['title']}} | Neighborhood Reporter">
...
<meta property="og:url" content="{{route('home')}}/e/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}">
<meta property="og:title" content="Local Event:{{$info['title']}} | Neighborhood Reporter">
<meta property="og:description" content="Check out the latest community post from one of your neighbors. (The views expressed in this post are the author’s own.)">
...
<meta property="twitter:url" content="{{route('home')}}/e/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}">
<meta property="twitter:title" content="Local Event:{{$info['title']}} | Neighborhood Reporter">
<meta property="twitter:description" content="Check out the latest community post from one of your neighbors. (The views expressed in this post are the author’s own.)">
    ...
    <div class="container pad-0">
        <div class="row mar-mob">
                    ...
                    <section class="st_Section event-sec">
                        <div class="st_SocialShare st_SocialShare--IsHidden st_SocialShare--IsSticky">
                            <a class="st_SocialShare__Action st_SocialShare__Action--facebook" target="_blank"
                               ...
                               href="https://www.facebook.com/sharer/sharer.php?u={{route('home')}}/e/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=facebook&utm_medium=web&utm_campaign=share">
                            ...
                            <a class="st_SocialShare__Action st_SocialShare__Action--twitter" target="_blank" alt="Tweet"
                               title="Tweet"
                               href="https://twitter.com/intent/tweet?text={{$info['title']}}&amp;url={{route('home')}}/e/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=twitter&utm_medium=web&utm_campaign=share">
                            ...
                            <a class="st_SocialShare__Action st_SocialShare__Action--linkedin" target="_blank"
                               ...
                               href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{route('home')}}/e/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=linkedin&utm_medium=web&utm_campaign=share">
                            ...
                            <a class="st_SocialShare__Action st_SocialShare__Action--reddit" target="_blank"
                               ...
                               href="http://www.reddit.com/submit?title={{$info['title']}}&amp;url={{route('home')}}/e/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=reddit&utm_medium=web&utm_campaign=share">
                            ...
                            <a class="st_SocialShare__Action st_SocialShare__Action--email" target="_blank" alt="Send email"
                               title="Send email"
                               href="mailto:?subject={{$info['title']}}&amp;body={{$info['venue']}}%0A%0A{{route('home')}}/e/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}?utm_source=shared-email&utm_medium=email&utm_campaign=share">
                            ...
                            <button class="st_SocialShare__Action st_SocialShare__Action--replies reply_btn" type="button">
                                ...
                                <strong class="st_SocialShare__Label">
                                    <span class="reply_count_number">{{$info['comment_count']}}</span>
                                </strong>
                            </button>
                        </div>
                        ...
                        <article class="st_Section__card">
                            <div class="st_CardDetail__Header">
                                ...
                                <div class="st_CardDetail__TitleWrapper">
                                    <h1 class="st_CardDetail__Title">{{$info['title']}}</h1>
                                </div>
                                <div class="st_SubHead {{($info['image'] == ''?'styles_SubHead--No-Image__2e-M4':'')}}">
                                    <div class="st_CardDetail__AvatarWrapper">
                                        <a>
                                            ...
                                            @else
                                            <i class="fa fa-user-circle avatar-icon avatar-icon--xs"></i>
                                            @endif
                                        </a>
                                        <div class="st_CardDetail__BylineWrapper">
                                            <div>
                                                <a class="st_CardDetail__Byline">
                                                    <strong>{{$info['userInfo']->name}}</strong>, Neighbor
                                                </a>
                                                <span class="st_Badges st_Badges--small"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="st_CalendarIconWrapper">
                                        <div class="calendar-icon calendar-icon--fixed calendar-icon--large">
                                            <div class="calendar-icon__date">
                                                <strong class="calendar-icon__month">{{ \Carbon\Carbon::parse($info['date'])->format('M') }}</strong>
                                                <strong class="calendar-icon__day">{{ \Carbon\Carbon::parse($info['date'])->format('d') }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if($info['image'] != '')
                            <figure>
                                <img alt="{{$info['title']}}" class="st_CardDetail__FeaturedImage" src="{{postgetImageUrl($info['image'],$info['created_at'])}}">
                            </figure>
                            @endif
                            <div class="st_EventDetails">
                                <section class="st_EventDetails__Header">
                                    <h3 class="st_EventDetails__Title">Event Details</h3>
                                </section>
                                <dl class="st_EventDetails__Description">
                                    <dt class="st_EventDetails__Item st_EventDetails__Item--Wrap st_EventDetails__Item--NoSpace">
                                        <div class="st_EventDetails__Datetime">
                                            <i class="fa fa-clock st_EventDetails__Icon"></i>
                                            <time>{{\Carbon\Carbon::parse($info['created_at'])->format('D, M j Y g:i A')}}</time>
                                        </div>
                                        <div class="dropdown">
                                            <button aria-haspopup="true" aria-expanded="false" id="js-add-to-calendar" type="button" class="dropdown-toggle btn">Add to calendar
                                                <i class="icon icon--space-left fal fa fa-chevron-down-fal"></i>
                                            </button>
                                            <div x-placement="bottom-start" aria-labelledby="js-add-to-calendar" class="dropdown-menu" >
                                                <div class="dropdown-item">
                                                    <a target="_blank" download="{{$info['title']}}" href="{{$info['ical']}}">iCal</a>
                                                </div>
                                                <div class="dropdown-item">
                                                    <a target="_blank" href="{{$info['google_link']}}" rel="nofollow">Google</a>
                                                </div>
                                                <div class="dropdown-item">
                                                    <a target="_blank" href="{{$info['outlook_link']}}" rel="nofollow">Outlook</a>
                                                </div>
                                                <div class="dropdown-item">
                                                    <a target="_blank" href="{{$info['yahoo_link']}}" rel="nofollow">Yahoo</a>
                                                </div>
                                            </div>
                                        </div>
                                    </dt>
                                    <dt class="st_EventDetails__Item">
                                        <i class="fa fa-map-marker-alt st_EventDetails__Icon st_EventDetails__Icon--SpaceLeft">
                                        </i>
                                        <a class="st_EventDetails__Link" target="_blank" href="https://maps.google.com/maps?z=10&amp;t=m&amp;q={{$info['venue']}}">
                                            <address class="st_EventDetails__Address">{{$info['venue']}}</address>
                                        </a>
                                    </dt>
                                    @if ($info['link'] != '')
                                    <dt class="st_EventDetails__Item">
                                        <i class="fa fa-globe st_EventDetails__Icon st_EventDetails__Icon--SpaceLeft"></i>
                                        <a class="st_EventDetails__moreInfoLink" target="_blank" href="{{$info['link']}}" rel="nofollow norefferer">
                                            <span class="st_EventDetails__moreInfo">More info: </span>{{$info['link']}}
                                        </a>
                                    </dt>
                                    @endif
                                </dl>
                            ...
                            <div class="st_CardDetail__Footer">
                                <div class="st_ActionBar">
                                    <div class="st_ActionBar__BarLeft">
                                        <button class="Button_ActionBar interested-labe intrest_button-post" data-postid="{{$info['id']}}" type="button"> 
                                            <span class="Button_ActionBar__Icon">
                                                <?php
                                                if (isset($info['userIntrestInfo']) && !$info['userIntrestInfo']->isEmpty()) {
                                            ...
                                            <span class="Button_ActionBar__Label__2BXDN">Interested ({{$info['intrest_count']}})</span> 
                                        </button>
                                        ...
                                        <button class="Button_ActionBar share share-button" data-title="{{$info['title']}}" data-url="/e/{{$info['id']}}/{{sanitizeStringForUrl($info['title'])}}" type="button"> 
                                            <span class="Button_ActionBar__Icon">
                                        ...
                                        <div class="st_FlagMenu">
                                            <div aria-label="flags" class="dropdown">
                                                <div class="js-content-flag-menu" aria-haspopup="true" aria-expanded="false" disabled="">
                                                    ...
                                                    <div class="flag-menu">
                                                        <ul class="dropdown-menu dropdown-menu-right" data-postid="{{$info['id']}}" data-type="event">
                            ...
                            <div class="st_ArticleThreadBlock__container no_border" id="reply_block_article_nid">
                                <div class="" id="collapseReply">
                                    ...
                                    <div class="st_Thread st_Thread--collapsed styles_Thread__3lAiJ" id="reply_div_{{$rvalue['id']}}">
                                        <section>
                                            ...
                                            <div class="st_ActionBar action_remove_{{$rvalue['id']}}">
                                                <div class="st_ActionBar__BarLeft">
                                                    <button aria-label="thank" class="Button_ActionBar like_button-post" data-postid="{{$rvalue['id']}}" data-type="event_reply" type="button">
                                                        <span class="Button_ActionBar__Icon">
                                                            <?php
                                                    ...
                                                    <div class="st_FlagMenu">
                                                        <div aria-label="flags" class="dropdown">
                                                            ...
                                                            <div class="dropdown-toggle" aria-haspopup="true" aria-expanded="false" disabled="">
                                                                ...
                                                                <div class="flag-menu">
                                                                    <ul class="dropdown-menu dropdown-menu-right" data-option='report' data-postid="{{$rvalue['id']}}" data-type="event_reply">
                                                                        <li class="st_FlagMenu__label">Reason for reporting:</li>
                                                                        <li class="st_FlagItem__link dropdown-item"><span>Spam</span></li>
                                                                        <li class="st_FlagItem__link dropdown-item"><span>Promotional</span></li>
                                                                        <li class="st_FlagItem__link dropdown-item"><span>Disagree</span></li>
                                        ...
                                        <div class="st_Thread st_Thread--collapsed styles_Thread__3lAiJ" id="reply_div_{{$crvalue['id']}}">
                                            <section>
                                                ...
                                                <div class="st_ActionBar action_remove_{{$crvalue['id']}}">
                                                    <div class="st_ActionBar__BarLeft">
                                                        <button aria-label="thank" class="Button_ActionBar like_button-post" data-postid="{{$crvalue['id']}}" data-type="event_reply" type="button">
                                                            <span class="Button_ActionBar__Icon">
                                                                <?php
                                                        ...
                                                        <div class="st_FlagMenu">
                                                            <div aria-label="flags" class="dropdown">
                                                                ...
                                                                <div class="dropdown-toggle" aria-haspopup="true" aria-expanded="false" disabled="">
                                                                    ...
                                                                    <div class="flag-menu">
                                                                        <ul class="dropdown-menu dropdown-menu-right" data-option='report' data-postid="{{$crvalue['id']}}" data-type="event_reply">
                                                                            <li class="st_FlagMenu__label">Reason for reporting:</li>
                                                                            <li class="st_FlagItem__link dropdown-item"><span>Spam</span></li>
                                                                            <li class="st_FlagItem__link dropdown-item"><span>Promotional</span></li>
                                                                            <li class="st_FlagItem__link dropdown-item"><span>Disagree</span></li>
                            ...
                            <article class="st_Card event_{{$epost['id']}}" id="event_{{$epost['id']}}">
                                ...
                                <div class="st_ActionBar">
                                    <div class="st_ActionBar__BarLeft">
                                        ...
                                        <a class="st_Card__ReplyLink" href="/e/{{$epost['id']}}/{{sanitizeStringForUrl($epost['title'])}}#reply_block_article_nid"> <i class="far fa-comment st_Card__ReplyLinkIcon"></i> Reply </a>
            ...
            <div class="right-sec">
                ...
                @if(!empty($regionadvetisement->advertisement))
                    {!! $regionadvetisement->advertisement !!}
                @else
                    <script onload="displayAdd(this);" type="text/javascript" id="coolerads-clip-code-14" src="https://mypaperonline.coolerads.com/js/clip-codes/content-clip-code.js?clip_id=14"></script><script type="text/javascript">CLIPCODE.init(14)</script>
                @endif
                {{-- <script onload="displayAdd(this);" type="text/javascript" id="coolerads-clip-code-14" src="https://mypaperonline.coolerads.com/js/clip-codes/content-clip-code.js?clip_id=14"></script><script type="text/javascript">CLIPCODE.init(14)</script> --}}
            </div>
        </div>
...
<script>
    ...
    jQuery(document).ready(function () {
        var $ = jQuery;
        $("#js-add-to-calendar").on("click", function (e) {
            $('.st_EventDetails__Item .dropdown .dropdown-menu').toggleClass('open-menu');
            e.stopPropagation()
        });
            ...
            if ($(this).parent().data('option') == 'edit') {
                if ($(this).find('span').text() == 'Edit') {
                    ...
                    if (confirm('Are you sure you want to delete this reply?')) {
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('delete-event-comment') }}",
